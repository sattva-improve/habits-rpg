...
const JOBS = [
  ...
  // Journeyman
  {
    ...
    icon: '🗡️',
    tier: 'journeyman',
    requirements: { level: 10, stats: { STR: 5 }, jobs: ['warrior_apprentice'] },
  ...
  },
  {
    ...
    icon: '📚',
    tier: 'journeyman',
    requirements: { level: 10, stats: { INT: 5 }, jobs: ['scholar_apprentice'] },
  ...
  },
  {
    ...
    icon: '🧘',
    tier: 'journeyman',
    requirements: { level: 10, stats: { MND: 5 }, jobs: ['monk_apprentice'] },
  ...
  },
  {
    ...
    icon: '⚒️',
    tier: 'journeyman',
    requirements: { level: 10, stats: { DEX: 5 }, jobs: ['artisan_apprentice'] },
  ...
  },
  {
    ...
    icon: '🎵',
    tier: 'journeyman',
    requirements: { level: 10, stats: { CHA: 5 }, jobs: ['performer_apprentice'] },
  ...
  },
  {
    ...
    icon: '🏋️',
    tier: 'journeyman',
    requirements: { level: 10, stats: { VIT: 5 }, jobs: ['athlete_apprentice'] },
  ...
  // Journeyman (複合ステータス系)
  {
    jobId: 'ranger',
    name: 'レンジャー',
    description: 'ゆみとしぜんをあやつるかりゅうど',
    icon: '🏹',
    tier: 'journeyman',
    requirements: { level: 10, stats: { DEX: 4, STR: 3 }, jobs: ['warrior_apprentice', 'artisan_apprentice'] },
    statBonuses: { DEX: 2, STR: 1 },
    expBonus: 1.1,
  },
  {
    jobId: 'paladin',
    name: 'パラディン',
    description: 'せいなるちからをやどすきし',
    icon: '✝️',
    tier: 'journeyman',
    requirements: { level: 10, stats: { STR: 4, MND: 3 }, jobs: ['warrior_apprentice', 'monk_apprentice'] },
  ...
  },
  {
    jobId: 'ninja',
    name: 'にんじゃ',
    description: 'かげにひそみ、しゅんびんにうごくもの',
    icon: '🥷',
    tier: 'journeyman',
    requirements: { level: 10, stats: { DEX: 4, INT: 3 }, jobs: ['artisan_apprentice', 'scholar_apprentice'] },
  ...
  },
  {
    jobId: 'spellblade',
    name: 'まほうけんし',
    description: 'けんとまほうをゆうごうさせたせんし',
    icon: '⚔️✨',
    tier: 'journeyman',
    requirements: { level: 10, stats: { STR: 4, INT: 3 }, jobs: ['warrior_apprentice', 'scholar_apprentice'] },
  ...
  },
  {
    jobId: 'dancer',
    name: 'おどりこ',
    description: 'ゆうがなまいでなかまをこぶするもの',
    icon: '💃',
    tier: 'journeyman',
    requirements: { level: 10, stats: { CHA: 4, VIT: 3 }, jobs: ['performer_apprentice', 'athlete_apprentice'] },
  ...
  },
  {
    jobId: 'alchemist',
    name: 'れんきんじゅつし',
    description: 'ぶっしつをへんようさせるひじゅつのつかいて',
    icon: '⚗️',
    tier: 'journeyman',
    requirements: { level: 10, stats: { INT: 4, DEX: 3 }, jobs: ['scholar_apprentice', 'artisan_apprentice'] },
