...
const JOBS: JobDefinition[] = [
  ...
  // ===== Grandmaster (極致) =====
  {
    ...
    requirements: {
      level: 99,
      stats: { VIT: 40, INT: 40, MND: 40, DEX: 40, CHA: 40, STR: 40 },
